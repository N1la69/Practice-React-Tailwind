...
function CustomerReviews() {
  return (
    <section className="max-container">
      ...
      <p className="mt-4 m-auto info-text max-w-lg text-center">Hear genuine stories from our satisfied customers about theri exceptional experiences with us.</p>
